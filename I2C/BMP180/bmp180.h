...
extern void I2C2_read(uint8_t slaveAddress, uint8_t Mem_Address, uint32_t *p_read, uint16_t num_bytes);
extern void I2C2_write_8b(uint8_t slaveAddress, uint8_t Mem_Address, uint32_t *p_read);
extern void I2C2_write(uint8_t slaveAddress, uint8_t Mem_Address, uint32_t *p_read, uint16_t num_bytes);
extern uint8_t I2C2_read_8b(uint8_t slaveAddress, uint8_t Mem_Address);
extern void I2C2_read_HAL(uint8_t slaveAddress, uint8_t Mem_Address, uint32_t *p_read, uint16_t num_bytes);
